...
window.graphTool = (containerId, options) => {
	...
	gt.color = {
		...
		// fill color must use 6-digit hex
		// medium purple
		// 3:1 with white
		// 4.5:1 with #0000a6
		// > 3:1 with #0000f5

...
sub _parserGraphTool_init {
  ...
  <script src="/webwork2_files/js/apps/GraphTool/graphtool.js" data-edfinity="preload" language="javascript"></script>
  <script src="/webwork2_files/js/apps/GraphTool/pointtool.js" data-edfinity="preload" language="javascript"></script>
  <script src="/webwork2_files/js/apps/GraphTool/quadratictool.js" data-edfinity="preload" language="javascript"></script>
  <script src="/webwork2_files/js/apps/GraphTool/cubictool.js" data-edfinity="preload" language="javascript"></script>
  <script src="https://cdn.jsdelivr.net/npm/jsxgraph@1.4.6/distrib/jsxgraphcore.js" data-edfinity="preload" language="javascript"></script>
  <link rel="stylesheet" type="text/css" href="/webwork2_files/js/apps/GraphTool/graphtool.css">
  <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/jsxgraph@1.4.6/distrib/jsxgraph.min.css">
...
<script>
initGraphTool_${ans_name} = function(enableEvents) {
  jsxOptions = $self->{JSXGraphOptions};
  jsxOptions.registerEvents = enableEvents;
